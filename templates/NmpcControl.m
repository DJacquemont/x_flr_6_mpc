...
% controller = NmpcControl(rocket, tf);
    ...
    methods
        ...
        function obj = NmpcControl(rocket, tf, expected_delay)
            ...
            u_init = [0,0, 60, 0]; % stay in playce init
            % YOUR CODE HERE YOUR CODE HERE YOUR CODE HERE YOUR CODE HERE
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function [u, T_opt, X_opt, U_opt] = get_u(obj, x0 , ref)
            ...
            for i = 1:delay
                ...
                k1 = obj.rocket.f(x_,        u_segment);
                k2 = obj.rocket.f(x_+h/2*k1, u_segment);
                k3 = obj.rocket.f(x_+h/2*k2, u_segment);
                k4 = obj.rocket.f(x_+h*k3,   u_segment);

                x_ = x_ + h/6*(k1+2*k2+2*k3+k4);
            end
